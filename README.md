...
### 2.1 Area of Irreglar Figure using Monte Carlo Method
 [Jupyter File](./chapter_2/area_of_irreglar_figure_using_monte.ipynb) <br/>
 [Python File](./chapter_2/same_python_file/Area_of_an_Irregular_Shape.py)

### 2.2 Gambling Game using Monte Carlo Method
 [Jupyter File](./chapter_2/gambling_game.ipynb) <br/>
 [Python File](./chapter_2/same_python_file/gambling_game.py)

### 2.3 Numerical Integration using Monte Carlo Method
 [Jupyter File Alternative 2](./chapter_2/numerical_integration_using_monte_alternative_2.ipynb)  &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File Alternative 3](./chapter_2/numerical_integration_using_monte_alternative_3.ipynb)  &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File](./chapter_2/numerical_integration_using_monte.ipynb) <br/>
 [Python File Alternative 2](./chapter_2/same_python_file/numerical_integration_using_monte_alternative_2.py)   &nbsp;&nbsp; / &nbsp;&nbsp; [Python File Alternative 3](./chapter_2/same_python_file/numerical_integration_using_monte_alternative_3.py)

### 2.4 Determining Value of PI (π) using Monte Carlo Method
 [Jupyter File Alternative 2](./chapter_2/pi_alternative_2.ipynb)  &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File](./chapter_2/pi.ipynb) <br/>
 [Python File Alternative 2](./chapter_2/same_python_file/pi_alternative_2.py)

### 2.5 Random Walk Problem using Monte Carlo Method
 [Jupyter File (2D)](./chapter_2/random_walk_2D.ipynb)   &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File (3D)](./chapter_2/random_walk_3D.ipynb)   &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File (Book)](./chapter_2/random_walk_boi.ipynb) <br/>
 [Python File (2D)](./chapter_2/same_python_file/random_walk_2D.py)   &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (3D)](./chapter_2/same_python_file/random_walk_3D.py)

### 2.6 Reliability Problem (Bearing OLD & NEW Policy) using Monte Carlo Method
 [Jupyter File (old policy)](./chapter_2/reliability_problem_old_policy.ipynb)   &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File (new policy)](./chapter_2/reliability_problem_new_policy.ipynb)   &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File (old vs new compare)](./chapter_2/reliability_problem_compare.ipynb)  <br/>
 [Python File (old policy)](./chapter_2/same_python_file/reliability_problem_old_policy.py)   &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (new policy)](./chapter_2/same_python_file/reliability_problem_new_policy.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (Combine code)](./chapter_2/same_python_file/Bearing%20Reliability.py) 
...
### 2.7 Simulation of Bombing Problem using Monte Carlo Method
 [Jupyter File (Rectangular Shape)](./chapter_2/rectangular_shape_bombing_area.ipynb) &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File (Circle Shape)](./chapter_2/circle_shape_bombing_area.ipynb) &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File (Any Shape)](./chapter_2/any_shape_bombing_area.ipynb)  <br/>
 [Python File (Rectangular Shape)](./chapter_2/same_python_file/rectangular_shape_bombing_area.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (Circle Shape)](./chapter_2/same_python_file/circle_shape_bombing_area.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (Any Shape)](./chapter_2/same_python_file/any_shape_bombing_area.py)


### 2.8 Hinge Assembly using Stochastic Model
 [Jupyter File](./chapter_2/hinge_assembly.ipynb)  <br/>
 [Python File](./chapter_2/same_python_file/hinge_assembly.py)

### 2.9 Four Tubes Problem using Stochastic Model
 [Jupyter File](./chapter_2/four_tubes_problem.ipynb)  <br/>
 [Python File](./chapter_2/same_python_file/four_tubes_problem.py)

<br/>

### (Exercise 5) Random Walk with Probability using Monte Carlo Method
 [jupyter File (2D) Exercise](./chapter_2/random_walk_2D_exercise.ipynb)   &nbsp;&nbsp; / &nbsp;&nbsp; [jupyter File (2D) Exercise 2](./chapter_2/random_walk_2D_exercise_2.ipynb)  <br/>
 [Python File (2D) Exercise](./chapter_2/same_python_file/random_walk_2D_exercise.py)   &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (2D) Exercise 2](./chapter_2/same_python_file/random_walk_2D_exercise_2.py)

### (Exercise 9) Uniform Distribution Random Variable
 [Jupyter File](./chapter_2/Exercise_9.ipynb)  <br/>
 [Python File](./chapter_2/same_python_file/Exercise_9.py)
...
<br/>
 ...
 [Jupyter File (2D No Animation)](./chapter_3/pure_pursuit_problem_2D_no_animation.ipynb) &nbsp;&nbsp; / &nbsp;&nbsp; [Jupyter File (3D No Animation)](./chapter_3/pure_pursuit_problem_3D_no_animation.ipynb) &nbsp;&nbsp; <br/>
 [Python File (2D No Animation)](./chapter_3/same_python_file/pure_pursuit_problem_2D_no_animation.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (3D No Animation)](./chapter_3/same_python_file/pure_pursuit_problem_3D_no_animation.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (2D Animation)](./chapter_3/same_python_file/pure_pursuit_problem_2D_animation.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (3D Animation)](./chapter_3/same_python_file/pure_pursuit_problem_3D_animation.py)
...
### 3.6 A Serial Chase Problem
 ...
 [Python File (No Plot Graph)](./chapter_3/same_python_file/serial_chase_problem.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (Plot Graph + No Animation)](./chapter_3/same_python_file/serial_chase_problem_gui.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (Plot Animation) (D goes straight line in y)](./chapter_3/same_python_file/serial_chase_problem_animation_1.py) &nbsp;&nbsp; / &nbsp;&nbsp; [Python File (Plot Animation) (D moves toward A)](./chapter_3/same_python_file/serial_chase_problem_animation_2.py)
 ### 3.7 Simulation of Exterior Ballistics
 [jupyter File](./chapter_3/simulation_of_exterior_ballistics.ipynb)     <br/>
 [Python File](./chapter_3/same_python_file/simulation_of_exterior_ballistics.py)
 ### (Exercise 2) Bullet Trajectory
 [jupyter File](./chapter_3/bullet_trajectory.ipynb)     <br/>
 [Python File](./chapter_3/same_python_file/bullet_trajectory.py)
 ### (Exercise 4) Cannon Fires Ball
 [jupyter File](./chapter_3/cannon_fires_ball.ipynb)     <br/>
 [Python File](./chapter_3/same_python_file/cannon_fires_ball.py)
 ### (Exercise 10) Serial Chase Exercise
 [jupyter File](./chapter_3/serial_chase_exercise.ipynb)     <br/>
 [Python File](./chapter_3/same_python_file/serial_chase_exercise.py)
...
### 4.5 Mid Square Random Number Generator
 [jupyter File](./chapter_4/mid_square_random_num_generator.ipynb)     <br/>
 [Python File](./chapter_4/same_python_file/mid_square_random_number_generator.py)

### 4.6 Congruence or Residue Random Number Generator
 [jupyter File](./chapter_4/congruence_or_residue_random_num_generator.ipynb)     <br/>
 [Python File](./chapter_4/same_python_file/congruence_or_residue_random_num_generator.py)

### 4.7 Arithmetic Congruential Random Number Generator
 [jupyter File](./chapter_4/arithmetic_congruential_random_num_generator.ipynb)     <br/>
 [Python File](./chapter_4/same_python_file/arithmetic_congruential_random_num_generator.py)

### 4.11 Kolmogorov - Smirnov Test
 [jupyter File](./chapter_4/kolmogorov_smirnov_test.ipynb)     <br/>
 [Python File](./chapter_4/same_python_file/kolmogorov_smirnov_test.py)
### 4.12 Chi Squared Test
 [jupyter File](./chapter_4/chi_squared_test.ipynb)     <br/>
 [Python File](./chapter_4/same_python_file/chi_squared_test.py)
### 4.13 Testing for Autocorrelation
 [jupyter File](./chapter_4/testing_for_autocorrelation.ipynb)     <br/>
 [Python File](./chapter_4/same_python_file/testing_for_autocorrelation.py)
### 4.14 Poker Test
